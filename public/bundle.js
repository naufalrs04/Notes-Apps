        ...
        (e.exports = (function () {
          ...
          class Vn {
            ...
            _main(e) {
              ...
              const r = Gn(qn);
              return Fe(qn, n), he.innerParams.set(qn, n), Un(qn, r, n);
            }
            then(e) {
                ...
                tt.swalPromiseResolve.set(e, r),
                  ...
                  (t.denyButton.onclick = () => {
                    ((e) => {
                      const t = he.innerParams.get(e);
                      e.disableButtons(),
                        t.returnInputValueOnDeny ? jt(e, "deny") : Tt(e, !1);
                    })(e);
                  }),
                  ...
                  ((e, t, n) => {
                    e.toast ? un(e, t, n) : (fn(t), hn(t), wn(e, t, n));
                  })(n, t, i),
                  ((e, t, n) => {
                    Ye(e),
                      t.toast ||
        ...
        function j(t, n, o) {
          ...
          return function (a, i) {
            ...
            for (o.method = a, o.arg = i; ; ) {
              ...
              "throw" === c.type &&
                ((r = g), (o.method = "throw"), (o.arg = c.arg));
            }
          };
        }
        function P(t, n) {
          ...
          (B.prototype = {
            ...
            finish: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                ...
                if (n.finallyLoc === e)
                  return this.complete(n.completion, n.afterLoc), S(n), b;
              }
            },
            catch: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
            ...
            },
            {
              ...
              value: function () {
                var e = this.shadowRoot.querySelector("#note-form"),
                  ...
                  l = this.shadowRoot.querySelector("#loading-indicator");
                function c() {
                ...
                function u() {
                  return o.value.trim().length < 5
                    ? ((s.textContent =
                        "Isi catatan harus minimal 5 karakter."),
                              ...
                              function (r) {
                                for (;;)
                                  switch ((r.prev = r.next)) {
                                    ...
                                    case 9:
                                      return (
                                        (f = r.sent), (r.next = 12), f.json()
                                      );
                                    case 12:
                                      (h = r.sent),
                                        f.ok && "success" === h.status
        ...
        function O(e, t) {
          function n(r, a, i, s) {
            ...
            if ("throw" !== l.type) {
              var c = l.arg,
                u = c.value;
              return u && "object" == f(u) && o.call(u, "__await")
        ...
        return (
          ...
          (r = [
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 19:
                              t().fire(
                                "Dibatalkan",
                                "Penghapusan catatan dibatalkan.",
                                "info",
                              );
                            case 20:
                            case "end":
            ...
            },
            {
              ...
              value: function (e) {
                var t = this.shadowRoot.querySelector(".loading-indicator");
                if (e) {
                  if (!t) {
                    var n = document.createElement("div");
                    n.classList.add("loading-indicator"),
